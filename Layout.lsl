...
<Layout version="1.6.1">
  ...
  <Components>
    ...
    <Component>
      ...
      <Settings>
        <Version>1.5</Version>
        <ScriptPath>C:\Users\Ali\Desktop\FAST Script\FAST 0.2 beta\New FAST\FAST Script.asl</ScriptPath>
        <Start>True</Start>
        <Reset>True</Reset>
        <Split>True</Split>
        <CustomSettings />
    ...
    <Component>
      ...
      <Settings>
        ...
        <ValueSource>TopLine</ValueSource>
        <BackgroundColor>00FFFFFF</BackgroundColor>
        <BackgroundColor2>00FFFFFF</BackgroundColor2>
        <BackgroundGradient>Plain</BackgroundGradient>
        <Display2Rows>False</Display2Rows>
    ...
    <Component>
      ...
      <Settings>
        ...
        <OverrideValueColor>False</OverrideValueColor>
        <ValueLocation>Variables</ValueLocation>
        <ValueSource>BottomLine</ValueSource>
        <BackgroundColor>00FFFFFF</BackgroundColor>
        <BackgroundColor2>00FFFFFF</BackgroundColor2>
        <BackgroundGradient>Plain</BackgroundGradient>
        <Display2Rows>False</Display2Rows>
